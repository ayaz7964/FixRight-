...
class MessageChatBotScreen extends StatelessWidget {
  final List <Contact> contacts  = const [
    Contact(userId: 'ahs786', conv: ['from ', 'Hello Ayaz ',
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(40) , color: Colors.amberAccent),
        height: 80,
        ...
        child: Row(
          children: [
            ...
            Expanded(
              ...
              child: Column(
                children: [
                 Text("Ayaz Hussain " , style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                  Text("Good Morning   " ,)
