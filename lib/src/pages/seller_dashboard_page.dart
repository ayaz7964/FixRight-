...
class SellerDashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Seller Dashboard', style: TextStyle(color: Colors.green)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _buildStatCard(title: 'Net Earnings', value: '\$1,250', color: Colors.green),
                const SizedBox(width: 10),
                _buildStatCard(title: 'Active Orders', value: '4', color: Colors.orange),
              ],
            ),
            Row(
              children: [
                _buildStatCard(title: 'Response Rate', value: '95%', color: Colors.blue),
                const SizedBox(width: 10),
                _buildStatCard(title: 'Average Rating', value: '4.9', color: Colors.purple),
              ],
            ),
            ...
            GridView.count(
              ...
              children: [
                _buildQuickLink(context, 'Post a New Gig', Icons.add_circle, Colors.green),
                _buildQuickLink(context, 'View Analytics', Icons.analytics, Colors.indigo),
                _buildQuickLink(context, 'Service Templates', Icons.copy, Colors.brown),
                _buildQuickLink(context, 'Promote Services', Icons.share, Colors.pink),
              ],
            ),
          ],
        ),
  ...
  Widget _buildQuickLink(BuildContext context, String title, IconData icon, Color color) {
    return Card(
      elevation: 2,
      child: InkWell(
        onTap: () {
